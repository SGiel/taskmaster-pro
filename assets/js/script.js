...
var auditTask = function(taskEl) {
  // to ensure elememt is gettnig to the function 
  // get date from task element
  var date = $(taskEl).find("span").text().trim();
  

  // convert moment object at 5:00pm = L is for user's local time
...
$("#modalDueDate").datepicker( {
  // set the minimum date to be one date from the current date
  minDate: 1
});
